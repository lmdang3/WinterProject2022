...
const validate = (values) => {
    ...
    if (!values.primaryPhone) {
        ...
        errors.primaryPhone = "Phone number has too many digits"
    }
    else if (values.primaryPhone.length < 10) {
                        ...
                        <div className="container mx-auto bg-white dark:bg-gray-800 mt-10 rounded px-4">
                            ...
                            <div className="mx-auto pt-4">
                                <div className="container mx-auto flex-wrap">
                                    ...
                                    <div className="flex">
                                        <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                                            <label htmlFor="primaryPhone" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                                                Primary Number
                                            </label>
                                            <input type="text" value={values.primaryPhone} name="primaryPhone" required onChange={handleChange} onBlur={handleBlur} className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder />
                                            {errors.primaryPhone && touched.primaryPhone && (
                                                <div className="text-red-600 text-xs italic">{errors.primaryPhone}</div>
                                            )}
                                        </div>
                                        ...
                                        <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6 ml-4">
                                            <label htmlFor="seondaryPhone" className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100">
                                                Secondary Number
                                            </label>
                                            <input type="text" name="seondaryPhone" value={values.secondaryPhone} onChange={handleChange} onBlur={handleBlur} className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm bg-transparent rounded text-sm focus:outline-none focus:border-indigo-700 placeholder-gray-500 text-gray-500 dark:text-gray-400" placeholder />
                                        </div>
                                    </div>
